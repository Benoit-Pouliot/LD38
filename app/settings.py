...
#PLAYER_STRENGTH
PICKAXE_STRENGTH_LEVEL = (0,1,2,4)
...
SPRING_COST = VAL_PINK1
LADDER_COST = VAL_GOLD1*2
ANTI_GRAVITY_COST = VAL_GREEN1
PICKAXE_LVL_COST = (0,0,VAL_PINK2*20,VAL_GREEN2*25)
DRILL_LVL_COST = (0,VAL_PINK1*10,VAL_GREEN1*20,VAL_RED1*25)
DYNAMITE_LVL_COST = (0,VAL_GREEN2*20,VAL_RED2*25)
