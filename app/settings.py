...
LADDER_COST = VAL_GOLD1*5
SPRING_COST = VAL_GREEN1*5
ANTI_GRAVITY_COST = VAL_GREEN1
PICKAXE_LVL_COST = (0,0,VAL_PINK2*8,VAL_GREEN2*12,VAL_RED2*16)
DRILL_LVL_COST = (0,VAL_GOLD2*11,VAL_PINK2*14,VAL_GREEN2*17)
DYNAMITE_LVL_COST = VAL_GREEN2
